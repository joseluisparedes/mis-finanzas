-- ======================================================
-- SISTEMA COMPLETO DE PERFILES PERSONALIZADOS
-- Incluye: tabla, funciones, triggers y RPC actualizadas
-- ======================================================
...
-- 5. Función para obtener todas las suscripciones CON PERFILES
...
-- 6. Función para obtener perfil completo del usuario
...
-- 7. Actualizar trigger de creación de usuario para incluir perfil por defecto
...
DO $$
BEGIN
    RAISE NOTICE '✅ Sistema de perfiles personalizado instalado completamente';
