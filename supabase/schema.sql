-- ==============================================
-- SCHEMA PARA MIS FINANZAS v2.1.0
...
CREATE INDEX IF NOT EXISTS idx_income_types_user ON income_types(user_id, is_active);

-- Índices para búsquedas por texto
CREATE INDEX IF NOT EXISTS idx_expenses_description ON expenses USING gin(to_tsvector('spanish', description));
CREATE INDEX IF NOT EXISTS idx_incomes_description ON incomes USING gin(to_tsvector('spanish', description));
