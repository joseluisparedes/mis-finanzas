-- Clean up ALL existing functions with this name
...
-- Create the function with EXACT parameter names expected by frontend
...
SELECT 'Function public.change_user_subscription created successfully' as status,
       'Parameters: target_user_email, new_subscription_type, payment_info' as signature;