-- ======================================================
-- CORRECCIÓN PARA ESQUEMA EXISTENTE
-- Solo aplicar las modificaciones necesarias
-- ======================================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ Funciones administrativas actualizadas exitosamente';
    RAISE NOTICE '🔄 Ahora ejecuta en la consola: supabase.rpc(''promote_myself_to_admin'')';
END $$;