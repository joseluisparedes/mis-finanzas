-- ======================================================
-- LIMPIAR FUNCIONES DUPLICADAS Y USAR JSONB CONSISTENTE
-- ======================================================

-- 1. Eliminar todas las versiones de las funciones conflictivas
...
DROP FUNCTION IF EXISTS promote_myself_to_admin();

-- 2. Actualizar ENUM para incluir 'family' si no existe
DO $$
BEGIN
    BEGIN
...
-- 3. Función para obtener todas las suscripciones (NUEVA VERSION LIMPIA)
...
-- 4. Función para obtener estadísticas (NUEVA VERSION LIMPIA)
...
-- 5. Función para cambiar suscripción (SOLO UNA VERSION CON JSONB)
...
-- 6. Actualizar función set_subscription_limits para incluir family
...
-- 7. Función especial para promoverse a admin
...
DO $$
BEGIN
    RAISE NOTICE '✅ Funciones limpiadas y recreadas con JSONB consistente';
